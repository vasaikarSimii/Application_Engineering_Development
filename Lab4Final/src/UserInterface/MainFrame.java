...
public class MainFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnSupplier.setBackground(new java.awt.Color(255, 51, 51));
    ...
    private void btnSupplierActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSupplierActionPerformed
        ...
        //System.out.print("Supplier clicked");
        CardLayout layout = (CardLayout)panelRight.getLayout();
        panelRight.add(new LoginScreen(panelRight, adminUser.getSuppDir().getSupplierList()));
        layout.next(panelRight);
        
//        List<User> ss=  adminUser.getSuppDir().getSupplierList();
//        
//        LoginScreen lg=new LoginScreen(panelRight,ss);
//        System.out.print("Supplier clicked"+lg.toString());
//        panelRight.add(lg);
//       
