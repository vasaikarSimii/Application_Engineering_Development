...
public class BrowseProducts extends javax.swing.JPanel {
 ...
 public void refreshOrderTable(){
    ...
    private void initComponents() {
        ...
        add(suppComboBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 140, 250, -1));
        ...
        add(addtoCartButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 340, -1, -1));
    ...
    private void addtoCartButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addtoCartButtonActionPerformed
        ...
        if (fetchQty<=0){
          JOptionPane.showMessageDialog(null, "Quantity can't be less than equal to zero");
            return;  
        }
        try{
        double salesPrice = Double.parseDouble(txtSalesPrice.getText());
        if(salesPrice<= selectedProduct.getPrice()){
            JOptionPane.showMessageDialog(null, "Sales Price cannot be less than price of the product"); 
            return;
           }
    ...
    private void btnModifyQuantityActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModifyQuantityActionPerformed
       ...
       if(selectedRow<0){
         JOptionPane.showMessageDialog(null, "Select a row to modify quantity"); 
         return;  
       }
       if(txtNewQuantity.getText() ==null) {
         JOptionPane.showMessageDialog(null, "Please enter a quantity to modify"); 
         return;  
       }
       try{
