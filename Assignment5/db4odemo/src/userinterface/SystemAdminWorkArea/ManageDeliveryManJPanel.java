...
private DeliveryManDirectory dm;
    ...
    public ManageDeliveryManJPanel(JPanel userProcessContainer, EcoSystem system) {
        ...
        this.system = system;
        populateTable();
        Organization organization = dm.createDeliveryMan(Organization.Type.DeliveryMan);
     ...
     private void populateTable() {
        ...
        model.setRowCount(0);
            ...
            for (DeliveryMan d : deliveryMan.getDeliveryManDirectory().getDeliveryManList()) {
