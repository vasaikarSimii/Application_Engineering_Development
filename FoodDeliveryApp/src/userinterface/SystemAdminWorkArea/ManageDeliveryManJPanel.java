...
//private OrganizationDirectory od;
   ...
   private void populateNetworkComboBox(){
    ...
    private void submitJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitJButtonActionPerformed
        ...
        UserAccount account = enterprise.getUserAccountDirectory().createUserAccount(username, password, employee, new DeliverManRole());
        JOptionPane.showMessageDialog(null, "DeliveryMan added sucessfully");
        populateTable();
